...
> = {
  RECEIVED: {
    label: "접수",
    dot: "bg-[var(--jm-text-subtle)]",
    tint: "bg-[var(--jm-surface-muted)] text-[var(--jm-text)]",
    ring: "ring-[var(--jm-border)]",
  },
  DIAGNOSING: {
    label: "진단중",
    dot: "bg-[var(--jm-warning-solid)]",
    tint: "bg-[var(--jm-warning-bg)] text-[var(--jm-warning-fg)]",
    ring: "ring-[var(--jm-warning-solid)]",
  },
  QUOTED: {
    label: "견적대기",
    dot: "bg-[var(--jm-warning-solid)]",
  ...
  APPROVED: {
    label: "승인",
    dot: "bg-[var(--jm-info-solid)]",
    tint: "bg-[var(--jm-info-bg)] text-[var(--jm-info-fg)]",
    ring: "ring-[var(--jm-info-solid)]",
  },
  REPAIRING: {
    label: "수리중",
    dot: "bg-[var(--jm-info-solid)]",
  ...
  READY: {
    label: "인계대기",
    dot: "bg-[var(--jm-success-solid)]",
    tint: "bg-[var(--jm-success-bg)] text-[var(--jm-success-fg)]",
    ring: "ring-[var(--jm-success-solid)]",
  },
  PICKED_UP: {
    label: "수리완료",
    dot: "bg-[var(--jm-text-subtle)]",
    tint: "bg-[var(--jm-surface-muted)] text-[var(--jm-text-muted)]",
    ring: "ring-[var(--jm-border)]",
  },
  CANCELLED: {
    label: "취소",
    dot: "bg-[var(--jm-danger-solid)]",
    tint: "bg-[var(--jm-danger-bg)] text-[var(--jm-danger-fg)]",
    ring: "ring-[var(--jm-danger-solid)]",
  },
};
