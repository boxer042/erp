  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-0.5 p-2.5 sm:p-3">
        ...
        <span className="line-clamp-2 text-[12px] font-semibold leading-tight text-zinc-900 sm:text-[13px]">
          {product.name}
        </span>
        {product.spec && (
        ...
        <span className="text-[14px] font-bold tabular-nums text-zinc-900 sm:text-[15px]">
          {autoNoPrice ? (
