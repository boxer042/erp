# POS v1 / v2 비교  (📦 ARCHIVED — 2026-05-07)

> **이 문서는 historical archive 입니다.** v1 은 폐기 완료되어 v2 가 기본 `/pos` 로 승격됨 (commit 4c5235f).
>
> **현재 운영 단일 출처: [docs/POS.md](POS.md)** — 라우트·운영 흐름·디자인 의도·후속작업 모두 정리.
>
> 이 파일은 v1/v2 전환 결정 과정의 기록으로만 보존. 새 작업 시 참고 금지 (라우트·UI 다수 stale).
>
